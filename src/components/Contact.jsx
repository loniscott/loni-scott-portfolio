...
const Contact = () => {
    ...
    return (
        ...
        <div className="container mt-5" id="contact">
            <h2 className="mb-3" style={{fontFamily: "Quattrocento", fontWeight: "bold" }}>Contact me!</h2>
            <form ref={form} onSubmit={handleSubmit}>
                <div className="mb-3">
                    <label className="form-label" htmlFor="name" style={{fontFamily: "Quattrocento" }}>
                        Name
                    </label>
                    <input className="form-control" type="text" id="name" name="name" value={formData.name} onChange={handleChange} required />
                </div>
                <div className="mb-3">
                    <label className="form-label" htmlFor="email" style={{fontFamily: "Quattrocento" }}>
                        Email
                    </label>
                    <br />
                ...
                <div className="mb-3">
                    <label className="form-label" htmlFor="message" style={{fontFamily: "Quattrocento"}}>
                        Message
                    </label>
